function [Q_mat_arr, beta_mat_arr, beta0_arr, A_mat_arr, Bern_K_arr, tau_arr,...
    ...
    = sglca_csp_fun_promoter(Y_arr, K, B, nrun, alpha0)
...
z_beta_mat = [zeros(K, K-1), ones(K,1)];
% z_beta_mat = [ones(K,1), zeros(K, K-1)];
...
for ii=1:nrun   
    ...
    [beta_mat, beta0] = get_gibbs_beta_uncons(beta_mat, beta0, Y_arr, PG_param, C_ij_minus_c,...

function [] = sglca_csp_simu(K, alpha0, n)
...
% pctRunOnAll load(strcat('datasets_rep50_K4d4_n', num2str(n), 'p20.mat'))
...
filename = strcat('msimu_CSPbeta_n', num2str(n), 'p', num2str(p),...
    '_Kini', num2str(K), '_d', num2str(d), '_allpos_rep', num2str(rep), '.mat');
